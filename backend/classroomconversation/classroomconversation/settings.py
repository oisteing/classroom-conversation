"""
Django settings for classroomconversation project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", default="$u0n)65c)f")
...
WSGI_APPLICATION = "classroomconversation.wsgi.application"
